...
<div class="col-span-12 mt-8">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
                        <button class="button text-white bg-theme-1 shadow-md mr-2" onClick="location.href='{{route('instructor.add.course')}}'">Add New Course</button>
                        ...
                        <table class="table table-report -mt-2">
                            ...
                            <tbody>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="{{$row->course_title}}" class="tooltip rounded-full" src="{{asset('/storage/course-image/'.$row->course_avatar)}}" title="Uploaded at 17 July 2021">
                                            </div>
                                    ...
                                    <td>
                                        <a href="{{route('instructor.managethis.course', $row->id)}}" class="font-medium whitespace-no-wrap">{{$row->course_title}}</a>
                                        <div class="text-gray-600 text-xs whitespace-no-wrap">{{$row->course_type}}</div>
                                    </td>
                                    <td class="text-center">&#8358; {{number_format($row->course_price)}}</td>
                                    <td class="w-40">
                                            ...
                                            <i data-feather="check-square" class="w-4 h-4 mr-2"></i>Disabled
                                            </div>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="{{route('instructor.editcourse', $row->id)}}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
